...
const E2E_ID_MAP = {
  ...
  "T007 project search finds matching projects": "T007",
  "T008 project filtering applies category filters": "T008",
  "T009 project detail page loads published project data": "T009",
  "T010 authenticated user can create a comment": "T010",
  "T011 authenticated user can edit their comment": "T011",
  "T012 authenticated user can delete their comment": "T012",
  "T013 other users cannot edit someone else's comment": "T013",
  "T014 admin can create a project": "T014",
  "T015 admin can edit a project": "T015",
  "T016 admin can delete a project": "T016",
  "T019 author info fallback shows text without embedded map": "T019",
...
const UNIT_ID_MAP = {
  ...
  "canManageComment allows owner or admin": "T013",
